...
<div id="fixedfoot" class="contactform">
    <div class="container visible" data-animation="zoomIn" data-timeout="200" style="text-align: center;">
        <br />
        <span class="fontbold fontorange fontxxxl">“零成本”</span><span class="fontwhite fontxxl">加盟西式快餐连锁品牌，已有</span>
        <span class="fontbold  fontorange fontxxxl"><smt:dict code="potential.user.count" /></span>
        <span class="fontwhite fontxxl">人免费获取开店盈利方案</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="btngetfree" id="btnGetZeroFeeAdvice">免费领取</button>
        <br />
        <br />
        <span class="fontwhite fontl">包括：盈利分析+技术培训+开店设备+选址分析+运营方案</span>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="fontwhite fontl">姓名：</span>
        <input type="text" class="inputbox" id="potencialUserName" />
        <span class="fontwhite fontl">电话：</span>
        <input type="text" class="inputbox" id="potencialUserTel" />
        <br /><br />
    </div>
</div>
<div class="space_xl"></div>
    ...
    <div>
        <div class="container visible" data-animation="zoomIn" data-timeout="200">
            <div class="row text-center">
                <div class="col-md-12 col-xs-12 fontwhite text-center contactqr">
                    <img src="images/qrcode2.png" style="width: 120px; height: 120px;" />
                    <p class="fontsize8"><span>关注微信公众号</span> </p>
                </div>
            </div>
        </div>
    </div>
    <div class="footer_bottom visible" data-animation="zoomIn" data-timeout="200">
        <div class="container">
            <div class="row text-center fontwhite fontsize7">
                ...
                <p>电话：021-68060630 咨询热线：400-168-6966 公司地址：上海市浦东新区周康路28号  周浦万达国际商务中心F栋2101</p>
                <p>Copyright ©2005 - 2016 上海鼎然餐饮管理有限公司 沪ICP备10007893号   </p>
            </div>
        </div>
    </div>
</div>
...
var menu1 = '${menu1}';
var menu2 = '${menu2}';
var viewDocMode = '${viewDocMode}';
var menu1Highlight = '#menu-${menu1Highlight}';
var menu2Highlight = '#menu-${menu2Highlight}';

if(viewDocMode!=''){
	$(menu1Highlight).addClass('current');
	$(menu2Highlight).addClass('on');
}
else{
	if(menu1!=''){
	...
	if(menu2!=''){
		...
		$('#pageSubTitle').text($('#menu-' + menu2).text());
	}
}
/** 零成本咨询 **/
...
$('document').ready(function(){
	setTimeout(function(){
		$('.nb-invite-body').attr('id','online_chat_now');
	}, 30000)
