   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="content-wrapper">
            <div class="content-heading">产品列表</div>
			            ...
			            <table class="table table-hover">
							...
							<c:forEach var="obj" items="${page.content}">
								<tr>
									...
									<td>${obj.id}</td>
									<td>${obj.id}</td>
									<td><a target="blank" href="admin/seoPrice/edit?id=${obj.id}">编辑</a></td>
									<td>
			...
			<a href="admin/seoPrice/edit" class="btn btn-primary">添加xxx</a>
         </div>
      </section>
...
var url = 'admin/seoPrice/list?a=a';
...
$('.linkDeleteObj').click(function(){
	...
	$.ajax({
		url: 'admin/seoPrice/delete?id=' + $(this).attr('objId'),
		method: 'get',
		success: function(){
			tr.fadeOut();
			tr.remove();
