    ...
    b.fn.ronbongpage = function(c) {
        ...
        function sa(a) {
            ...
            if (!W(a.target)) {
                ...
                u = d.y,
                A = d.x,
                a.find(".fp-slides").length && Math.abs(B - A) > Math.abs(v - u) ? Math.abs(B - A) > b(window).width() / 100 * c.touchSensitivity && (B > A ? l.right && b.fn.ronbongpage.moveSlideRight() : l.left && b.fn.ronbongpage.moveSlideLeft()) : c.autoScrolling && !c.scrollBar && Math.abs(v - u) > b(window).height() / 100 * c.touchSensitivity && (v > u ? z("down", e) : u > v && z("up", e)))
            }
        }
        function W(a, d) {
            d = d || 0;
        ...
        function ha() {
            if (c.responsive) {
                ...
                b(window).width() < c.responsive ? a || (b.fn.ronbongpage.setAutoScrolling(!1, "internal"),
                b("#fp-nav").hide(),
                g.addClass("fp-responsive")) : a && (b.fn.ronbongpage.setAutoScrolling(N.autoScrolling, "internal"),
                b("#fp-nav").show(),
        ...
        b.fn.ronbongpage.setAutoScrolling = function(a, d) {
            ...
            b.fn.ronbongpage.setRecordHistory(c.recordHistory, "internal"),
            g.css({
            ...
            b.fn.ronbongpage.setRecordHistory(!1, "internal"),
            g.css({
                "-ms-touch-action": "",
                "touch-action": ""
            }),
        ...
        b.fn.ronbongpage.setAllowScrolling = function(a, c) {
            if ("undefined" != typeof c)
                ...
                if (b.fn.ronbongpage.setMouseWheelScrolling(!0),
                C || P)
                    MSPointer = oa(),
            ...
            } else if (b.fn.ronbongpage.setMouseWheelScrolling(!1),
            C || P)
                MSPointer = oa(),
        ...
        ;
        var t = !1, C = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/), P = "ontouchstart"in window || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, g = b(this), h = b(window).height(), m = !1, x = !1, p, K, k, ca = "ronbongpage-wrapper", l = {
            up: !0,
            down: !0,
            left: !0,
            right: !0
...
(function() {
    ...
    window.Rbslider = function(container, params) {
        if (!(this instanceof Rbslider))
            return new Rbslider(container,params);
        var defaults = {
        ...
        s.updateSlidesProgress = function(translate) {
            ...
            if (s.slides.length === 0)
                return;
            if (typeof s.slides[0].rbsliderSlideOffset === 'undefined')
                s.updateSlidesOffset();
        ...
        s.onTouchMove = function(e) {
            ...
            if (isTouchEvent && e.type === 'mousemove')
                return;
            if (e.preventedByNestedRbslider)
                return;
...
$("body section div").mousemove(function(event){
	return false;
});
