...
!function(e, t, o, a) {
    ...
    o(function() {
        ...
        o(".offsidebar.hide").removeClass("hide"),
        ...
        e.fullCalendar({
            ...
            drop: function(t, n) {
                ...
                if (i) {
                    ...
                    s.start = t,
                    s.allDay = n,
                    s.backgroundColor = r.css("background-color"),
                    s.borderColor = r.css("border-color"),
                    e.fullCalendar("renderEvent", s, !0),
                    a.is(":checked") && r.remove()
                }
            },
...
function(e, t, o, a) {
    o(function() {
        if ("undefined" != typeof Chartist) {
            ...
            a.on("created", function() {
                e.__exampleAnimateTimeout && (clearTimeout(e.__exampleAnimateTimeout),
                e.__exampleAnimateTimeout = null),
                e.__exampleAnimateTimeout = setTimeout(a.update.bind(a), 12e3)
            })
        }
    })
}(window, document, window.jQuery),
function(e, t, o) {
    ...
    e(o).on("click", "[data-reset-key]", function(o) {
        ...
        a ? (e.localStorage.remove(a),
        t.location.reload()) : e.error("No storage key specified for reset.")
    })
}(jQuery, window, document),
function(e, t, o, a) {
    o(function() {
        o.fn.colorpicker && (o(".demo-colorpicker").colorpicker(),
...
function(e, t, o, a) {
    "undefined" != typeof screenfull && o(function() {
        ...
        (i.indexOf("MSIE ") > 0 || i.match(/Trident.*rv\:11\./)) && r.addClass("hide"),
        r.is(":visible") && (r.on("click", function(e) {
            e.preventDefault(),
            screenfull.enabled ? (screenfull.toggle(),
            a(r)) : console.log("Fullscreen not enabled")
        }),
    ...
    if (e.fn.gMap) {
        ...
        e("[data-gmap]").each(function() {
            ...
            if (o) {
                ...
                n.push(f),
                void 0 !== t.data("styled") && f.setOptions({
                    styles: a
                })
            }
        })
        ...
        if (o.fn.cropper) {
            var a = o(".img-container > img")
              ...
              , c = {
                ...
                preview: ".img-preview",
                crop: function(e) {
                    n.val(Math.round(e.x)),
                    r.val(Math.round(e.y)),
                    i.val(Math.round(e.height)),
                    s.val(Math.round(e.width)),
                    l.val(Math.round(e.rotate))
                }
            };
            a.on({
            ...
            o(t.body).on("click", "[data-method]", function() {
                var e, t, n = o(this).data();
                if (a.data("cropper") && n.method) {
                    if (n = o.extend({}, n),
                    void 0 !== n.target && (e = o(n.target),
                    void 0 === n.option))
                        try {
                    ...
                    if (t = a.cropper(n.method, n.option),
                    "getCroppedCanvas" === n.method && o("#getCroppedCanvasModal").modal().find(".modal-body").html(t),
                    o.isPlainObject(t) && e)
                        try {
            ...
            f ? u.change(function() {
                ...
                /^image\/\w+$/.test(e.type) ? (d = f.createObjectURL(e),
                a.one("built.cropper", function() {
                    f.revokeObjectURL(d)
                }).cropper("reset").cropper("replace", d),
                u.val("")) : alert("Please choose an image file."))
            }) : u.parent().remove(),
            o(".docs-options :checkbox").on("change", function() {
                var e = o(this);
                a.data("cropper") && (c[e.val()] = e.prop("checked"),
                a.cropper("destroy").cropper(c))
            }),
            o('[data-toggle="tooltip"]').tooltip()
        }
    })
            ...
            var a = o.localStorage.get("jq-appLang") || "en"
              , n = {
                ...
                callback: function(e, t) {
                    o.localStorage.set("jq-appLang", a),
                    t(e)
                }
            };
            e(n),
            o("[data-set-lang]").on("click", function() {
                (a = o(this).data("setLang")) && (n.language = a,
                e(n),
                t(o(this)))
            })
        }
...
function(e, t, o) {
    ...
    function a(t) {
        var o = t.data("message")
          , a = t.data("options");
        o || e.error("Notify: No message specified"),
        e.notify(o, a || {})
    }
    e(o);
    e(function() {
...
function(e, t, o) {
    var a = {}
      ...
      , s = function(t) {
        this.options = e.extend({}, s.defaults, t),
        this.uuid = "ID" + (new Date).getTime() + "RAND" + Math.ceil(1e5 * Math.random()),
        this.element = e(['<div class="uk-notify-message alert-dismissable">', '<a class="close">&times;</a>', "<div>" + this.options.message + "</div>", "</div>"].join("")).data("notifyMessage", this),
        this.options.status && (this.element.addClass("alert alert-" + this.options.status),
        this.currentstatus = this.options.status),
        this.group = this.options.group,
        n[this.uuid] = this,
        a[this.options.pos] || (a[this.options.pos] = e('<div class="uk-notify uk-notify-' + this.options.pos + '"></div>').appendTo("body").on("click", ".uk-notify-message", function() {
...
function(e, t, o) {
    ...
    e('[data-tool="panel-collapse"]').each(function() {
        var t = e(this)
          ...
          , c = t.children("em")
          , d = o.attr("id");
        s.length || (s = o.children(".panel-heading").nextAll().wrapAll("<div/>").parent().addClass("panel-wrapper"),
        l = {}),
        s.collapse(l).on("hide.bs.collapse", function() {
            n(c),
            r(d, "hide"),
            s.prev(".panel-heading").addClass("panel-heading-collapsed")
        }).on("show.bs.collapse", function() {
            a(c),
            r(d, "show"),
            s.prev(".panel-heading").removeClass("panel-heading-collapsed")
        });
        var u = i(d);
...
function(e, t, o) {
    ...
    function a(t, o) {
        ...
        a || (a = {}),
        a[this.id] = e(this).sortable("toArray"),
        a && e.localStorage.set(r, a)
    }
    function n() {
...
function(e, t, o, a) {
    o(function() {
        if ("undefined" != typeof Rickshaw) {
            for (var e = [[], [], []], o = new Rickshaw.Fixtures.RandomData(150), a = 0; a < 150; a++)
                o.addData(e);
            var n = [{
                color: "#c05020",
                data: e[0],
...
function(e, t, o, a) {
    ...
    function s() {
        o(".sidebar-subnav.nav-floating").remove(),
        o(".dropdown-backdrop").remove(),
        o(".sidebar li.open").removeClass("open")
    }
    function l() {
    ...
    o(function() {
        ...
        t.on("show.bs.collapse", function(e) {
            e.stopPropagation(),
            0 === o(this).parents(".collapse").length && t.filter(".in").collapse("hide")
        });
        var a = o(".sidebar .active").parents("li");
        u() || a.addClass("active").children(".collapse").collapse("show"),
        g.find("li > a + ul").on("show.bs.collapse", function(e) {
            u() && e.preventDefault()
        });
        var r = l() ? "click" : "mouseenter"
          , s = o();
        g.on(r, ".nav > li", function() {
            (c() || u()) && (s.trigger("mouseleave"),
            s = i(o(this)),
            n())
        }),
...
function(e, t, o, a) {
    o(function() {
        o("[data-skycon]").each(function() {
            ...
            e.html('<canvas width="' + e.data("width") + '" height="' + e.data("height") + '"></canvas>'),
            t.add(e.children()[0], e.data("skycon")),
            t.play()
        })
    })
}(window, document, window.jQuery),
...
function(e, t, o, a) {
    o(function() {
        function t() {
            ...
            a.type = a.type || "bar",
            a.disableHiddenCheck = !0,
            t.sparkline(n, a),
            a.resize && o(e).resize(function() {
                t.sparkline(n, a)
            })
        }
...
function(e, t, o, a) {
    o(function() {
        ...
        o("[data-toggle-state]").on("click", function(a) {
            a.stopPropagation();
            var n = o(this)
              ...
              , l = i ? o(i) : t;
            r && (l.hasClass(r) ? (l.removeClass(r),
            s || toggle.removeState(r)) : (l.addClass(r),
            s || toggle.addState(r))),
            o(e).resize()
        })
    }),
    e.StateToggler = function() {
        var e = {
            ...
            removeWord: function(e, t) {
                if (this.hasWord(e, t))
                    return e.replace(new RegExp("(^|\\s)*" + t + "(\\s|$)*","g"), "")
            }
        };
        return {
            addState: function(t) {
                ...
                a = a ? e.addWord(a, t) : t,
                o.localStorage.set("jq-toggleState", a)
            },
            removeState: function(t) {
                var a = o.localStorage.get("jq-toggleState");
                a && (a = e.removeWord(a, t),
                o.localStorage.set("jq-toggleState", a))
            },
...
function(e, t, o, a) {
    o(function() {
        ...
        e.length) {
            ...
            t.init(),
            o("#start-tour").on("click", function() {
                t.restart()
            })
        }
    })
...
function(e, t, o) {
    ...
    ,
    e.support.touch = "ontouchstart"in t && navigator.userAgent.toLowerCase().match(/mobile|tablet/) || t.DocumentTouch && document instanceof t.DocumentTouch || t.navigator.msPointerEnabled && t.navigator.msMaxTouchPoints > 0 || t.navigator.pointerEnabled && t.navigator.maxTouchPoints > 0 || !1,
    e.support.mutationobserver = t.MutationObserver || t.WebKitMutationObserver || t.MozMutationObserver || null,
    e.Utils = {},
    e.Utils.debounce = function(e, t, o) {
        var a;
        return function() {
            var n = this
              , r = arguments
    ...
    e.Utils.removeCssRules = function(e) {
        ...
        e && setTimeout(function() {
            try {
                for (d = document.styleSheets,
                n = 0,
                s = d.length; n < s; n++) {
                    for (a = d[n],
                    o = [],
                    a.cssRules = a.cssRules,
                    t = r = 0,
                    l = a.cssRules.length; r < l; t = ++r)
                        a.cssRules[t].type === CSSRule.STYLE_RULE && e.test(a.cssRules[t].selectorText) && o.unshift(t);
                    for (i = 0,
                    c = o.length; i < c; i++)
                        a.deleteRule(o[i])
                }
    ...
    e.Utils.isInView = function(t, o) {
        ...
        c + a.height() >= i && c - o.topoffset <= i + n.height() && l + a.width() >= r && l - o.leftoffset <= r + n.width()
    }
    ,
    ...
    e.langdirection = "rtl" == a.attr("dir") ? "right" : "left",
    e(function() {
